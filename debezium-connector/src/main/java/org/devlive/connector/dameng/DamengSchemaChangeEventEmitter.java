...
public class DamengSchemaChangeEventEmitter implements SchemaChangeEventEmitter {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(DamengSchemaChangeEventEmitter.class);
    ...
    public DamengSchemaChangeEventEmitter(OracleConnectorConfig connectorConfig, OraclePartition partition,
