...
import org.devlive.connector.dameng.logminer.UnistrHelper;
...
public class DamengValueConverters extends JdbcValueConverters {
    ...
    private final DamengConnectorConfig.IntervalHandlingMode intervalHandlingMode;
    ...
    public SchemaBuilder schemaBuilder(Column column) {
        ...
        switch (column.jdbcType()) {
            // Dameng's float is not float as in Java but a NUMERIC without scale
            case Types.FLOAT:
                return variableScaleSchema(column);
            case Types.NUMERIC:
                return getNumericSchema(column);
            case DamengTypes.BINARY_FLOAT:
                return SchemaBuilder.float32();
            case DamengTypes.BINARY_DOUBLE:
                return SchemaBuilder.float64();
            case DamengTypes.TIMESTAMPTZ:
            case DamengTypes.TIMESTAMPLTZ:
                return ZonedTimestamp.builder();
            case DamengTypes.INTERVALYM:
            case DamengTypes.INTERVALDS:
                return intervalHandlingMode == DamengConnectorConfig.IntervalHandlingMode.STRING ? Interval.builder() : MicroDuration.builder();
            case Types.STRUCT:
                return SchemaBuilder.string();
            case DamengTypes.ROWID:
                return SchemaBuilder.string();
            default: {
    ...
    protected BigDecimal withScaleAdjustedIfNeeded(Column column, BigDecimal data) {
        // deal with Dameng negative scales
    ...
    protected Object fromDamengTimeClasses(Column column, Object data) {
        try {
    ...
    protected Object convertTimestampToEpochMillisAsDate(Column column, Field fieldDefn, Object data) {
        ...
        return super.convertTimestampToEpochMillisAsDate(column, fieldDefn, fromDamengTimeClasses(column, data));
    }
    ...
    protected Object convertTimestampToEpochMicros(Column column, Field fieldDefn, Object data) {
        ...
        return super.convertTimestampToEpochMicros(column, fieldDefn, fromDamengTimeClasses(column, data));
    }
    ...
    protected Object convertTimestampToEpochMillis(Column column, Field fieldDefn, Object data) {
        ...
        return super.convertTimestampToEpochMillis(column, fieldDefn, fromDamengTimeClasses(column, data));
    }
    ...
    protected Object convertTimestampToEpochNanos(Column column, Field fieldDefn, Object data) {
        ...
        return super.convertTimestampToEpochNanos(column, fieldDefn, fromDamengTimeClasses(column, data));
    }
    ...
    protected Object convertTimestampToUtcIsoString(Column column, Field fieldDefn, Object data) {
        ...
        return super.convertTimestampToUtcIsoString(column, fieldDefn, fromDamengTimeClasses(column, data));
    }
    ...
    protected Object convertTimestampWithZone(Column column, Field fieldDefn, Object data) {
        ...
        final Object javaData = fromDamengTimeClasses(column, data);
    ...
    protected Object convertIntervalYearMonth(Column column, Field fieldDefn, Object data) {
        return convertValue(column, fieldDefn, data, NumberConversions.LONG_FALSE, (r) -> {
            if (data instanceof Number) {
                ...
                if (intervalHandlingMode == DamengConnectorConfig.IntervalHandlingMode.STRING) {
                ...
                convertDamengIntervalYearMonth(data, r);
            }
            else if (data instanceof String) {
                ...
                convertDamengIntervalYearMonth(interval, r);
            }
        });
    }

    private void convertDamengIntervalYearMonth(Object data, ResultReceiver r) {
    ...
    protected Object convertIntervalDaySecond(Column column, Field fieldDefn, Object data) {
        return convertValue(column, fieldDefn, data, NumberConversions.LONG_FALSE, (r) -> {
            if (data instanceof Number) {
                ...
                convertDamengIntervalDaySecond(data, r);
            }
            else if (data instanceof String) {
                String value = (String) data;
                INTERVALDS interval;
                ...
                convertDamengIntervalDaySecond(interval, r);
            }
        });
    }

    private void convertDamengIntervalDaySecond(Object data, ResultReceiver r) {
    ...
    private String convertHexToRawFunctionToString(Column column, String function) {
        try {
            switch (column.jdbcType()) {
                case DamengTypes.NVARCHAR:
                case DamengTypes.NCHAR:
    ...
    /**
     * Converts the supplied {@code HEXTORAW} function and argument to a specific Dameng numeric data type.
     *
     * @param column the column
